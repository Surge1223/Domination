...
import com.annihilation.dominationdonate.ThemerConstants.APK_SIGNATURE_PRODUCTION
import com.annihilation.dominationdonate.ThemerConstants.BASE_64_LICENSE_KEY
import com.annihilation.dominationdonate.ThemerConstants.ENABLE_KNOWN_THIRD_PARTY_THEME_MANAGERS
import com.annihilation.dominationdonate.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL
import com.annihilation.dominationdonate.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL
import com.annihilation.dominationdonate.ThemerConstants.ENFORCE_INTERNET_CHECK
import com.annihilation.dominationdonate.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION
import com.annihilation.dominationdonate.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION
import com.annihilation.dominationdonate.ThemerConstants.PIRACY_CHECK
import com.annihilation.dominationdonate.ThemerConstants.SUBSTRATUM_FILTER_CHECK
import com.annihilation.dominationdonate.ThemerConstants.THEME_READY_GOOGLE_APPS
import com.annihilation.dominationdonate.internal.SystemInformation.SUBSTRATUM_PACKAGE_NAME
import com.annihilation.dominationdonate.internal.SystemInformation.checkNetworkConnection
import com.annihilation.dominationdonate.internal.SystemInformation.getSelfSignature
import com.annihilation.dominationdonate.internal.SystemInformation.getSelfVerifiedIntentResponse
import com.annihilation.dominationdonate.internal.SystemInformation.getSelfVerifiedPirateTools
import com.annihilation.dominationdonate.internal.SystemInformation.getSelfVerifiedThemeEngines
import com.annihilation.dominationdonate.internal.SystemInformation.getSubstratumUpdatedResponse
import com.annihilation.dominationdonate.internal.SystemInformation.hasOtherThemeSystem
import com.annihilation.dominationdonate.internal.SystemInformation.isCallingPackageAllowed
import com.annihilation.dominationdonate.internal.SystemInformation.isPackageInstalled
import com.annihilation.dominationdonate.internal.TBOConstants.THEME_READY_PACKAGES
import java.io.File
import java.util.*
